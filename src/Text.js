...
export default class Text extends React.Component {
  static propTypes = {
    addSetectedText: React.PropTypes.func.isRequired,
    colorForSelection: React.PropTypes.string.isRequired,
  }

  render() {
    console.log('render Text');
    return <div onClick={() => console.log('click')} onMouseUp={() => this.addSelectedText()} className="text" id='text'>
